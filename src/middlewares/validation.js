...
const validationCreate = [
    ...
    body('contraseña').isLength({ max: 10}).withMessage('Debe tener como maxim 10 caracteres').bail() ,
    body('passwordconfirm').isLength({ max: 10 }).withMessage('Debe tener como maxim 10 caracteres').bail(), 
